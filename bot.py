...
# Шаги диалога
NAME, BIRTHDATE, BIRTHTIME, BIRTHCITY, WISH, BUDGET = range(6)

BUDGETS = [
    ["💸 До 2 000 руб", "💰 2 000 – 5 000 руб"],
    ["💎 5 000 – 10 000 руб", "✨ Свыше 10 000 руб"]
]
...
async def get_wish(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        parse_mode="Markdown",
        reply_markup=ReplyKeyboardMarkup(BUDGETS, one_time_keyboard=True, resize_keyboard=True)
    )
    return BUDGET
